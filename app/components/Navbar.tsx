  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-white shadow-sm">
      ...
      <div className="bg-blue-700 hidden sm:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-9 flex items-center justify-end gap-5 text-xs text-blue-100">
          <span className="flex items-center gap-1.5 whitespace-nowrap">
            ...
            <span className="hidden lg:inline">+91-9910931384 &nbsp;|&nbsp; 8920409936 &nbsp;|&nbsp; 0129-411-6107</span>
            <span className="lg:hidden">+91-9910931384 &nbsp;|&nbsp; 8920409936</span>
          </span>
          ...
          <a href="/contact" className="bg-white text-blue-700 px-3 py-0.5 rounded font-semibold hover:bg-blue-50 transition-colors whitespace-nowrap">
            Contact Us
          </a>
        </div>
      </div>
          ...
          <nav className="hidden md:flex items-stretch">
            {navItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className="flex items-center px-4 text-[15px] font-semibold border-b-2 transition-colors whitespace-nowrap text-slate-700 border-transparent hover:text-blue-600 hover:border-blue-400"
              >
                {item.label}
              </a>
            ))}
          ...
          <nav className="max-w-7xl mx-auto px-4 py-2 flex flex-col">
            {navItems.map((item) => (
              <a
                ...
                className="py-3 px-2 text-[15px] font-semibold text-slate-700 hover:text-blue-600 border-b border-slate-50 last:border-0 transition-colors"
              >
                {item.label}
              </a>
            ))}
